export default function Navbar() {
  return (
    <header className="sticky top-0 flex flex-wrap lg:justify-start lg:flex-nowrap w-full bg-white text-lg py-3 dark:bg-neutral-800 z-50">
      <nav className="max-w-full w-full mx-8 lg:flex lg:items-center lg:justify-between">
