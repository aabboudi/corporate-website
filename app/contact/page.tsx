      ...
      <main className="container max-w-7xl px-8 mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="col-span-1 space-y-6">
            <div className="text-xl font-bold">Or do it the old way.</div>
        ...
        <h2 className="text-center text-3xl font-bold my-8">Come visit!</h2>
        <div className="flex flex-wrap justify-center gap-8">
          <div className="flex-1 min-w-[250px]">
            <h3 className="text-xl font-semibold">Corporate HQ</h3>
            <p className="text-balance">
              525 Corporate Drive, Suite 203 Stafford, VA 22554
            </p>
          </div>
          <div className="flex-1 min-w-[250px]">
            <h3 className="text-xl font-semibold">Europe</h3>
            <p className="text-balance">
              25, Place De La Madeleine 75008 Paris 08, France
            </p>
          </div>
